...
// Generate app download option with direct link
function generateAppDownloadQR() {
    // Create container for app download
    const appDownloadContainer = document.createElement('div');
    appDownloadContainer.id = 'app-download-container';
    appDownloadContainer.classList.add('app-download-container');
    
    // Add header and download button
    appDownloadContainer.innerHTML = `
        <div class="download-header">
            <h3>Enhanced Navigation</h3>
            <button class="close-download">&times;</button>
        </div>
        <div class="download-content">
            <p>Download our enhanced indoor navigation app for a better experience</p>
            <a href="http://shreyaslohiafr.github.io/dt-app1/Indoor%202.0.apk" class="download-button" id="direct-download-btn">
    ...
    // Style the container
    appDownloadContainer.style.position = 'fixed';
    appDownloadContainer.style.bottom = '20px';
    appDownloadContainer.style.left = '20px';
    appDownloadContainer.style.backgroundColor = 'white';
    appDownloadContainer.style.padding = '15px';
    appDownloadContainer.style.borderRadius = '10px';
    appDownloadContainer.style.boxShadow = '0 4px 20px rgba(0,0,0,0.15)';
    appDownloadContainer.style.zIndex = '1000';
    
    // Style the header
    const header = appDownloadContainer.querySelector('.download-header');
    ...
    const closeBtn = appDownloadContainer.querySelector('.close-download');
    ...
    const downloadBtn = appDownloadContainer.querySelector('.download-button');
    downloadBtn.style.display = 'block';
    downloadBtn.style.backgroundColor = 'var(--primary-color, #4f46e5)';
    downloadBtn.style.color = 'white';
    downloadBtn.style.padding = '10px 20px';
    downloadBtn.style.borderRadius = '5px';
    downloadBtn.style.textDecoration = 'none';
    downloadBtn.style.margin = '15px auto 5px';
    downloadBtn.style.textAlign = 'center';
    downloadBtn.style.fontWeight = 'bold';
    
    // Add close button functionality
    closeBtn.addEventListener('click', () => {
        appDownloadContainer.remove();
    });
    
    // Add to body
    document.body.appendChild(appDownloadContainer);
}

// Add app download option to the sidebar
function addAppDownloadOption() {
    const mapSidebar = document.querySelector('.map-sidebar');
    
    if (!mapSidebar) return;
    
    // Create the download app banner
    const downloadBanner = document.createElement('div');
    downloadBanner.classList.add('download-app-banner');
    ...
    downloadBanner.innerHTML = `
        ...
        <a href="http://shreyaslohiafr.github.io/dt-app1/Indoor%202.0.apk" class="download-btn">
    ...
    downloadBanner.style.padding = '10px';
    downloadBanner.style.backgroundColor = '#f8f9fa';
    downloadBanner.style.borderRadius = '8px';
    downloadBanner.style.marginTop = '20px';
    downloadBanner.style.boxShadow = '0 2px 5px rgba(0,0,0,0.1)';
    
    // Style the app icon
    const appIcon = downloadBanner.querySelector('.app-icon');
    appIcon.style.width = '40px';
    appIcon.style.height = '40px';
    appIcon.style.backgroundColor = 'var(--primary-color, #4f46e5)';
    ...
    // Style the app info heading
    const appInfoHeading = appInfo.querySelector('h4');
    appInfoHeading.style.margin = '0';
    appInfoHeading.style.fontSize = '16px';
    
    // Style the app info paragraph
    const appInfoParagraph = appInfo.querySelector('p');
    appInfoParagraph.style.margin = '2px 0 0';
    appInfoParagraph.style.fontSize = '12px';
    appInfoParagraph.style.color = '#666';
    
    // Style the download button
    const downloadBtn = downloadBanner.querySelector('.download-btn');
    downloadBtn.style.backgroundColor = 'var(--primary-color, #4f46e5)';
    downloadBtn.style.color = 'white';
    ...
    downloadBtn.addEventListener('click', function(e) {
        // The button is now an anchor tag with href, no need to prevent default
    });
    
    // Add the banner to the sidebar
    mapSidebar.appendChild(downloadBanner);
}

// Update for the main navigation button
document.addEventListener('DOMContentLoaded', () => {
    const downloadAppBtn = document.getElementById('download-app-btn');
    
    if (downloadAppBtn) {
        // Change to direct link
        downloadAppBtn.href = "http://shreyaslohiafr.github.io/dt-app1/Indoor%202.0.apk";
    }
    
    // Initialize the app download option in the sidebar
